...
class DimensionalRelationshipTargetTest extends FunSuite {
  ...
  private val docBuilder: SaxonDocumentBuilder = {
    val otherRootDir = new File(classOf[DimensionalRelationshipTargetTest].getResource("/xbrl-and-w3").toURI)
    val zipFile = new File(classOf[DimensionalRelationshipTargetTest].getResource("/xdt-conf-cr4-2009-10-06.zip").toURI)
