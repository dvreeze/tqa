 ...
 */
class PrimaryItemDimensionalValidation271Test extends AnyFunSuite {
  ...
  private val docBuilder: SaxonDocumentBuilder = {
    ...
    val zipFile = new File(classOf[PrimaryItemDimensionalValidation271Test].getResource("/xdt-conf-cr4-2009-10-06.zip").toURI)
  ...
  private val testCaseUri: URI = {
    val relativeUri = URI.create("200-xbrldie/271-PrimaryItemDimensionallyInvalidError/271-Testcase-PrimaryItemDimensionallyInvalidError.xml")
