...
/**
 * Model of table linkbase content, as free from XML as possible. The model is not XPath-aware,
 ...
 *
 * This model is not dependent on the (table) DOM, relationship and query API packages. The reverse
