...
trait NonStandardRelationshipContainerApi {
   ...
   */
  def findAllOutgoingNonStandardRelationships(source: Node): immutable.IndexedSeq[NonStandardRelationship]

  /**
   * Filters non-standard relationships that are outgoing from the given node.
   */
  def filterOutgoingNonStandardRelationships(source: Node)(
      p: NonStandardRelationship => Boolean): immutable.IndexedSeq[NonStandardRelationship]
   ...
   */
  def findAllIncomingNonStandardRelationships(target: Node): immutable.IndexedSeq[NonStandardRelationship]

  /**
   * Filters non-standard relationships that are incoming to the given node.
   */
  def filterIncomingNonStandardRelationships(target: Node)(
      p: NonStandardRelationship => Boolean): immutable.IndexedSeq[NonStandardRelationship]
