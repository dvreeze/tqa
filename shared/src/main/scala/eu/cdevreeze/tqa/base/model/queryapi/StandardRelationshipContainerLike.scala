...
trait StandardRelationshipContainerLike extends StandardRelationshipContainerApi {
  ...
  final def filterOutgoingStandardRelationships(
    ...
    standardRelationshipsBySource.getOrElse(sourceConcept, immutable.IndexedSeq()).filter(p)
  }
  ...
  final def filterOutgoingStandardRelationshipsOfType[A <: StandardRelationship](
    ...
    standardRelationshipsBySource.getOrElse(sourceConcept, immutable.IndexedSeq()).collect {
